							...
							<table width="100%">
								<tbody>
									<tr>
										<td align="right" colspan="2">
											<ButtonGroup>
												<Button color="light" size="xs" onClick={(e) => this.edit(e, item)} ><i className="fa fa-edit"></i> Edit</Button>
												<Button color="light" size="xs" onClick={(e) => this.delete(e, item)}><i className="fa fa-trash"></i> Delete</Button>
											</ButtonGroup>
										</td>
									</tr>
								</tbody>
							...
							<table width="100%">
								<tbody>
									<tr>
										<td align="right" colspan="2">
											<ButtonGroup>
												<Button color="light" size="xs" onClick={(e) => this.cancel(e, item, formId)}><i className="fa fa-rotate-left"></i> Cancel</Button>
												<Button color="light" size="xs" onClick={(e) => this.save(e, item)} ><i className="fa fa-save"></i> Save</Button>
		...
		if(this.state.items && this.state.items.length === 0){
			...
			if(this.props.attribute.items && this.props.attribute.items.attributes) {
				...
				this.state.items.map(data => {
					...
					var formId = 'jsoager_array_form_' + indexdata
					indexdata++
