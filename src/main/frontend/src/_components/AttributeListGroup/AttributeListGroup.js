...
const defaultProps = {
    cardClassName: "jsoa-borderless jsoager-form-card",
...
class AttributeListGroup extends Component {
                    ...
                    <React.Fragment>
                        ...
                        <tr className="noBorder">
                            <td colSpan="3" className="paddingless">
                                <Row>
                                    <Col lg="8">
                                        <label className="jsoager-form-title-level-1">{attribute.title}</label>
                                    </Col>
                                    <Col lg="4">
                        ...
                        <React.Fragment>
                            ...
                            <tr>
                                <td colSpan="3" className="paddingless">
                                    <Row>
                                        <Col lg="8">
                                            <label className="jsoager-form-title-level-1">{title}</label>
                                        </Col>
                                        <Col lg="4">
                                            <div className="float-right">
                                                {headerActions}
        ...
        if(this.props.displayHeader === 'true' && this.props.attributesListConfig.title) {
            header = <tr>
                <td colSpan="3" className="paddingless">
                    <Row>
                        <Col lg="8">
                            <h3 className="jsoager-form-title-level-0">{this.props.attributesListConfig.title.toUpperCase()}</h3>
                        </Col>
                        <Col lg="4">
                            <div className="float-right">
                                {headerActions}
    ...
    render() {
                ...
                finalheader = (
                    <table width="100%">
						<tbody>
							...
							<tr>
								<td colSpan="3" className="paddingless">
									<div className="jsoager-form-title-level-0-line"></div>
								</td>
							</tr>  
						</tbody>
                    </table>
        ...
        if(footer){
            finalFooter = (
                <div className="jsoager-form-footer-actions">
                    <Row>{footer}</Row>
                </div>
            )
        }
        ...
        // body classname
        var bodyClassName = "jsoager-form-cardbody";
        if(this.props.attributesListConfig.addHeaderMargin || this.props.addHeaderMargin){
            bodyClassName = "jsoager-form-cardbody jsoager-top-margin-20";
        }
		...
		if(this.props.attributesListConfig.formId){
			body = <Card className={this.props.cardClassName}>
				<CardBody  className="paddingless jsoager-form-cardbody">
