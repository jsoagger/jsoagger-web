...
function getAllSchemasByInternalName(internalName) {
    var url = `${API_ROOT}/anon/api/viewDefinition/getAllSchemasByInternalName`;
...
function getUISchemaByInternalName(internalName, platform) {
    console.debug("getUISchemaByInternalName : " + internalName + ", on platform : " + platform);
    var url = `${API_ROOT}/anon/api/viewDefinition/getUISchemaByInternalName`;
