                ...
                <Card>
                    <CardBody>
                        <div className="align-items-center">
                            <img src={'../../assets/img/avatars/1.png'} className="img-profile" alt="jsoageruser" />
                        </div>
                    </CardBody>
                </Card>
                <Card>
                    <CardBody>
                        <div className="align-items-center">
                            <p className="jsoager-profile-text-item-1"><strong>{this.props.nickName}</strong></p>
                            <p className="jsoager-profile-text-item">{this.props.login}</p>
                        </div>
                    </CardBody>        
                </Card>
            </React.Fragment>
