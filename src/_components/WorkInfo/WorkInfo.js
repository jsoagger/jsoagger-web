...
class WorkInfo extends Component {
    ...
    workableActions = () => {
        ...
        if(this.props.displayActions == true){
            return (
                <React.Fragment>
                        <Col col="3" sm="12" md="3" className="float-right">
                            <Button block color="light" hidden={!wc} onClick={this.checkin}><i className="fa fa-unlock"></i>&nbsp;CHECKIN</Button>
                        </Col>
                        <Col col="3" sm="12" md="3" className="float-right">
                            <Button block color="light" hidden={!wc} onClick={this.undocheckout}><i className="fa fa-trash-o"></i>&nbsp;UNDO</Button>
                        </Col>
                        <Col col="3" sm="12" md="3" className="float-right">
                            <Button block color="light" hidden={wc} onClick={this.checkout}><i className="fa fa-lock"></i>&nbsp;CHECKOUT</Button>
                        </Col>
                </React.Fragment>
            )
        }
