...
import { Button, Col, Container, Input, InputGroup, InputGroupAddon, InputGroupText, Row, CardHeader, 
    CardText,
    CardImg,
    CardTitle, Card, CardBlock,
...
const mapDispatchToProps = (disptach) => ({
	updateSearchTerm: (e) => disptach(actions.updateHeaderSearchCompSearchTerm(e)),
})
